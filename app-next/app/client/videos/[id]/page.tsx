...
export default async function VideoDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    ...
    <main className="vd-shell">
      ...
      {/* Desktop left column: video */}
      <div className="vd-left">
        {/* Desktop header overlaid on video */}
      ...
      {/* Desktop right column / Mobile meta strip */}
      <div className="vd-right">
        {/* Desktop panel header */}
        <div className="vd-right-header">
          <div style={{ fontSize: 13, fontWeight: 700, color: '#9d9488', textTransform: 'uppercase' as const, letterSpacing: '0.05em' }}>Details</div>
        </div>
