...
// configured in Settings today and will start working the moment the
// credentials are added — no code change needed then.
//
// Auth uses the account's main Auth Token (Basic Auth with the Account SID)
// rather than a scoped API Key, since that's the credential already
